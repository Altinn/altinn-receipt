export const nb: Record<string, Record<string, string>> = {
  receipt_platform: {
    ...
    helper_text_a2lookup: 'Informasjonen som ble hentet ut fra det offentlige, er lagret og signert i Altinn. Klikk på lenke/vedlegg for å se informasjonen i et eget vindu.',
